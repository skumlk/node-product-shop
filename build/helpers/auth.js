...
exports.generatePasswordHash = exports.generateAuthenticationToken = exports.comparePassword = void 0;
...
function generateAuthenticationToken(user) {
    return jsonwebtoken_1.default.sign({ _id: user.id, isAdmin: user.isAdmin }, config_1.config.JWT_PRIVATE_KEY);
}
