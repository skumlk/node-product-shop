...
const AuthValidationService_1 = __importDefault(require("../validation/AuthValidationService"));
const UserModelService_1 = __importDefault(require("../models/UserModelService"));
let AuthService = class AuthService {
    constructor(authValidationService, userModelService) {
...
AuthService = __decorate([
    (0, typedi_1.Service)(),
    __metadata("design:paramtypes", [AuthValidationService_1.default,
        UserModelService_1.default])
], AuthService);
